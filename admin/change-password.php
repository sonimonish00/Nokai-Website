...
{
$sql=mysqli_query($bd,"SELECT password FROM admin where password='".$_POST['oldpass']."'");
if (!$sql) {
    printf("Error: %s\n", mysqli_error($bd));
    exit();
}
$num=mysqli_fetch_array($sql);
  ...
  if($num>0)
  {
   ...
   $con=mysqli_query($bd,"update admin set password='".$_POST['newpass']."'where emailid='".$_SESSION['login']."'");
   // $_SESSION['login']   $_SESSION['id']
   if (!$con) 
   {
    printf("Error: %s\n", mysqli_error($bd));
    exit();
  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Change Admin Password </h3>
				<div class="row">
				          <div class="col-md-12">
